...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    public void onCreate() {
        ...
        applicationTrafficCounter = ApplicationTrafficCounter.getInstance(this);
    }
    ...
    private void showNotification(String msg, String tickerText, boolean lowpriority, long when, ConnectionStatus status) {
        ...
        nbuilder.setContentTitle("Hideninja");
    ...
    PendingIntent getLogPendingIntent() {
        ...
        try {
            ...
            PendingIntent startIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
            return startIntent;
        } catch (Exception e) {
            return null;
        }
...
//        return startLW;
    ...
    public void onDestroy() {
        applicationTrafficCounter.stop();
        synchronized (mProcessLock) {
            if (mProcessThread != null) {
                mManagement.stopVPN();
            }
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        if (level == ConnectionStatus.LEVEL_CONNECTED) {
            applicationTrafficCounter.start();
        } else {
            applicationTrafficCounter.stop();
        }
